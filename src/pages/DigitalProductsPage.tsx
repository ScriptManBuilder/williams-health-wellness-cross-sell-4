      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              Our digital products include membership portal access, wellness platform, mobile applications, 
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Membership Portal:</strong> Cloud-based wellness platform accessible via web browser
              </LegalListItem>
              <LegalListItem>
                <strong>API Access:</strong> RESTful API for partners and affiliates to integrate wellness services
              </LegalListItem>
              <LegalListItem>
                <strong>Wellness Dashboard:</strong> Tools to schedule telehealth appointments, track wellness activities, and access health reports
              </LegalListItem>
              <LegalListItem>
                <strong>Mobile Applications:</strong> iOS and Android apps for accessing wellness benefits and managing your membership
              </LegalListItem>
              <LegalListItem>
                <strong>Wellness Guides:</strong> Digital health resources, wellness programs, and member benefits information
              </LegalListItem>
              <LegalListItem>
                <strong>Documentation & Support:</strong> Help articles, wellness program tutorials, FAQs, and health tips
              </LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>
                <strong>Email Delivery:</strong> Appointment confirmations, membership details, and wellness resources are sent to your email
              </LegalListItem>
              <LegalListItem>
                <strong>Account Required:</strong> An active membership account is required for access to exclusive wellness benefits
              </LegalListItem>
            </LegalList>
          </LegalSection>
