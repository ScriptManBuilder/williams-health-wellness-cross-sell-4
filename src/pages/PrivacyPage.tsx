        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              our health & wellness membership services and visit our website.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem><strong>Financial Information:</strong> Payment card details, bank account information, membership transaction history</LegalListItem>
            </LegalList>

            <LegalParagraph style={{ fontWeight: 600, marginTop: '1.5rem' }}>
              Member and Health Data
            </LegalParagraph>
            <LegalList>
              <LegalListItem><strong>Health Activity Data:</strong> Gym visits, wellness appointments, telehealth consultations, activity status</LegalListItem>
              <LegalListItem><strong>Member Information:</strong> Names, health preferences, wellness goals, special requirements</LegalListItem>
              <LegalListItem><strong>Communication Records:</strong> Email correspondence, support tickets, appointment confirmations</LegalListItem>
            </LegalList>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem><strong>Service Delivery:</strong> Schedule wellness appointments, send appointment confirmations, manage health activities</LegalListItem>
              ...
              <LegalListItem><strong>Communication:</strong> Send appointment updates, wellness notifications, exclusive offers, membership benefits</LegalListItem>
              <LegalListItem><strong>Analytics:</strong> Analyze wellness patterns, improve service performance, develop new health features</LegalListItem>
              <LegalListItem><strong>Compliance:</strong> Comply with legal obligations, prevent fraud, enforce our terms</LegalListItem>
              <LegalListItem><strong>Marketing:</strong> Send promotional wellness programs, personalize content, conduct market research</LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Service Providers:</strong> Gyms, healthcare providers, telehealth platforms, payment processors, email service providers, 
                analytics platforms, cloud hosting providers who assist in delivering our wellness services
              </LegalListItem>
              <LegalListItem>
                <strong>Business Partners:</strong> Healthcare providers, wellness platforms, fitness networks, and integration partners 
