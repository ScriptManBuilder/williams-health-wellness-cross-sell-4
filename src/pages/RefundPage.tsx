      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              At {process.env.REACT_APP_COMPANY_NAME}, we are committed to providing high-quality health & wellness membership services. 
          ...
          <LegalSection>
            <LegalSectionTitle>Healthcare Services and Appointments</LegalSectionTitle>
            <LegalParagraph>
              For healthcare services accessed through our platform:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Telehealth Consultations:</strong> Virtual appointments with licensed healthcare providers are included \n                with your membership at no additional cost. No refunds for unused telehealth visits.
              </LegalListItem>
              <LegalListItem>
                <strong>Gym Memberships:</strong> Access to 10,000+ fitness locations nationwide is included with active membership. \n                No refunds for unused gym visits as access is unlimited.
              </LegalListItem>
              <LegalListItem>
                <strong>Wellness Programs:</strong> Nutrition counseling, mental health support, and preventive care services \n                are fully included in membership fees with no additional charges.
              </LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Platform Outage:</strong> If our wellness platform is unavailable for more than 48 consecutive hours due to 
              ...
              <LegalListItem>
                <strong>Service Access Issues:</strong> If you paid for membership but wellness services were not accessible due 
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>Completed healthcare services and telehealth consultations that have been used</LegalListItem>
              <LegalListItem>Fitness classes or gym visits that have already occurred</LegalListItem>
              <LegalListItem>Wellness consultations that have been completed</LegalListItem>
              <LegalListItem>Access to member-only wellness programs, historical health data, or wellness reports</LegalListItem>
              <LegalListItem>Third-party fees (provider cancellation penalties, etc.)</LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>Third-party service disruptions (gyms, healthcare providers, wellness professionals)</LegalListItem>
