      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "WILLIAMS HEALTH" or "WMS*[Health Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "WILLIAMS PERKS" or healthcare provider names for specific services
              </LegalListItem>
              <LegalListItem>
