        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              {process.env.REACT_APP_COMPANY_NAME} when you interact with our health & wellness membership platform and healthcare services.
            </LegalParagraph>
            <LegalParagraph>
              By creating an account, accessing wellness benefits, or using our membership services, 
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides exclusive health & wellness membership benefits and healthcare services. 
              Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Health & Wellness Services:</strong> Access to 10,000+ gyms, telehealth consultations, nutrition programs, and mental health support
              </LegalListItem>
              <LegalListItem>
                <strong>Membership Benefits:</strong> Email and notifications about exclusive wellness programs and member rewards
              </LegalListItem>
              <LegalListItem>
                <strong>Appointment Management:</strong> Secure portal for scheduling telehealth visits, managing wellness activities, and tracking progress
              </LegalListItem>
              <LegalListItem>
                <strong>Wellness Support:</strong> 24/7 assistance with telehealth appointments, wellness programs, and concierge services
              </LegalListItem>
              <LegalListItem>
                <strong>Secure Payment Processing:</strong> PCI-compliant payment processing for all membership services
              </LegalListItem>
            </LegalList>
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We act as your health & wellness service provider and facilitate access through our partner network of gyms, healthcare providers, 
              and wellness professionals nationwide.
            </LegalParagraph>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Authorization:</strong> You authorize us to charge your payment method for wellness services, membership fees, 
                and any applicable taxes or fees
              </LegalListItem>
              <LegalListItem>
                <strong>Accuracy:</strong> You warrant that all payment and member information provided is accurate and up-to-date
              </LegalListItem>
              <LegalListItem>
                <strong>Sufficient Funds:</strong> You must ensure your payment method has adequate balance or 
                sufficient funds or credit available for the services
              </LegalListItem>
              <LegalListItem>
                <strong>Service Confirmation:</strong> By accessing a service, you authorize the charge and agree to the 
                terms and policies of the specific wellness provider
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              Regarding refunds and service disputes:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Wellness Provider Responsibility:</strong> Cancellation and refund requests should be submitted through our platform 
                according to the specific wellness provider's cancellation policy
              </LegalListItem>
              <LegalListItem>
                <strong>Cancellation Policy:</strong> Each service is subject to the cancellation policy of the specific gym, healthcare provider, 
                or wellness professional
              </LegalListItem>
              <LegalListItem>
                <strong>Processing Assistance:</strong> We will assist in facilitating refunds for services made through our platform
              </LegalListItem>
              <LegalListItem>
              ...
              <LegalListItem>
                <strong>Investigation:</strong> We will investigate disputed charges and work with you and the wellness provider to resolve
                the issue
              </LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>
                We share data with wellness providers and partners only as necessary to facilitate services and provide wellness benefits
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>
                We are not liable for wellness provider actions, service quality, or service fulfillment issues
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              ...
              <LegalListItem>At the request of a wellness provider or payment processor</LegalListItem>
