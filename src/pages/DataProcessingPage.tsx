        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              and {process.env.REACT_APP_COMPANY_NAME} ("Data Processor") for the provision of health & wellness membership and healthcare services.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>Providing health & wellness membership and telehealth services as described in the service agreement</LegalListItem>
              <LegalListItem>Analyzing wellness preferences to recommend suitable health programs</LegalListItem>
              <LegalListItem>Communicating with members regarding healthcare appointments and wellness benefits</LegalListItem>
              <LegalListItem>Processing payments and managing membership transactions</LegalListItem>
              <LegalListItem>Providing customer support and wellness assistance</LegalListItem>
              <LegalListItem>Generating wellness reports and analytics for the Data Controller</LegalListItem>
            ...
            <LegalParagraph style={{ marginTop: '1rem' }}>
              ...
              payment information, health data history, wellness preferences, and communication records.
            </LegalParagraph>
            <LegalParagraph>
              The categories of Data Subjects include: members, patients, potential members, and authorized representatives of 
              the Data Controller.
            </LegalParagraph>
          </LegalSection>
