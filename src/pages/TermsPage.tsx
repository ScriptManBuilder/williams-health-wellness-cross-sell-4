        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              health & wellness membership program.
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} provides exclusive health & wellness benefits and membership perks designed to help 
              members improve their wellbeing and access comprehensive healthcare services. Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>Unlimited access to 10,000+ gyms, fitness studios, and wellness centers nationwide</LegalListItem>
              <LegalListItem>24/7 telehealth services with licensed physicians and healthcare specialists</LegalListItem>
              <LegalListItem>Personalized nutrition programs, mental health counseling, and preventive care</LegalListItem>
              <LegalListItem>Access to member-only wellness resources and exclusive health programs</LegalListItem>
              <LegalListItem>Wellness support, health planning, and customer service</LegalListItem>
            </LegalList>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              Our health & wellness membership is provided on a subscription basis, as detailed in your membership agreement. 
            ...
            <LegalList>
              ...
              <LegalListItem>Healthcare appointments and services are included with membership benefits</LegalListItem>
